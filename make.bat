...
:do_fe
echo [QNU AI Platform] Dang khoi chay Frontend Studio...
start "QNU Frontend Studio (Port 3001)" cmd /k "cd frontend && npm run dev"
goto end
...
echo   make dev          : Khoi chay ca Backend 8001 va Frontend 3001
echo   make be           : Khoi chay rieng Backend API 8001
echo   make fe           : Khoi chay rieng Frontend Studio 3001
