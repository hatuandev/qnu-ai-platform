  ...
  const defaultAssistants = [
    {
      ...
      model: "GPT-4o-mini",
      description:
        "Tư vấn đề án tuyển sinh, điểm chuẩn, phương thức xét tuyển, học phí và học bổng",
      status: "active",
      icon: GraduationCap,
    },
    {
      ...
      description:
        "Giải đáp quy chế đào tạo tín chỉ, đăng ký học phần, chuẩn đầu ra và tốt nghiệp",
      status: "active",
      icon: ShieldCheck,
    },
    {
      ...
      description:
        "Tra cứu giáo trình số, luận văn thạc sĩ, cơ sở dữ liệu quốc tế và quy định mượn trả",
      status: "active",
      icon: Library,
    },
    {
      ...
      model: "GPT-4o",
      description:
        "Soạn thảo và kiểm định thể thức văn bản hành chính theo Nghị định 30/2020/NĐ-CP",
      status: "active",
      icon: FileText,
    },
    {
      ...
      model: "GPT-4o",
      description:
        "Thiết kế ma trận đề thi 4 mức độ Bloom và biên soạn ngân hàng câu hỏi theo chuẩn đầu ra",
      status: "active",
      icon: Sparkles,
    },
  ];
