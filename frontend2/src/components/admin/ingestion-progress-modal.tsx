...
export const IngestionProgressModal: React.FC<IngestionProgressModalProps> = ({
  ...
  const stages: PipelineStage[] = [
    {
      ...
      description:
        "Đẩy tệp nhị phân gốc lên MinIO bucket lưu trữ phân tán an toàn",
    ...
    },
    {
      ...
      description:
        "Nhận diện cấu trúc đoạn văn bản, tái tạo bảng số liệu và tiêu đề",
    ...
    },
    {
      ...
      description:
        "Phân mảnh văn bản theo ngữ nghĩa hoặc chuẩn Điều/Khoản quy phạm",
    ...
    },
    {
      ...
      description:
        "Tạo vector embeddings nạp vào Qdrant và đánh chỉ mục tìm kiếm từ khóa",
  ...
  const progressPercent = Math.min(
    100,
    Math.round(((currentStage - 1) / 4) * 100),
  );
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
            ...
            >
              {isDone ? (
                ...
                <>
                  ...
                  CHẶNG {Math.min(4, currentStage)}/4
                </>
              )}
            </Badge>
          </DialogTitle>
          <DialogDescription className="text-xs text-muted-foreground">
            ...
            • Bộ sưu tập:{" "}
            <span className="text-primary font-medium">{collectionName}</span>
          </DialogDescription>
        </DialogHeader>
