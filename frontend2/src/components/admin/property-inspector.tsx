...
export const PropertyInspector: React.FC<PropertyInspectorProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      const parsed = {
        id: node.id,
        type:
          typeof node.workflowNodeType === "string"
  ...
  const handleSaveJson = () => {
    try {
      ...
      onUpdateNode(node.id, {
        label:
          typeof parsed.display_name === "string" ? parsed.display_name : label,
        timeoutSeconds:
        ...
        workflowNodeType:
          typeof parsed.type === "string" ? parsed.type : node.workflowNodeType,
      ...
      setJsonError(
        err instanceof Error ? err.message : "Định dạng JSON không hợp lệ",
      );
    }
  };

  const nodeType =
    typeof node.workflowNodeType === "string" ? node.workflowNodeType : "";

  return (
    <aside
      aria-label="Bảng Thuộc Tính Node"
      className="absolute top-3 right-3 z-30 w-88 max-h-[calc(100%-1.5rem)] flex flex-col rounded-surface bg-card/95 backdrop-blur-md border border-border shadow-xl overflow-hidden animate-in fade-in slide-in-from-right-3 duration-200"
    >
      {/* Header */}
                ...
                <div className="space-y-2.5 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateConfigField("instruction", e.target.value)
                      }
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Nhập prompt định hướng cho node chuẩn hóa lỗi gõ nhầm và
                      từ viết tắt phù hợp với quy trình này. Hỗ trợ placeholder{" "}
                      {"{query}"}.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateConfigField("use_fast_rules", checked)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <div>
                      ...
                      <span className="text-[10px] text-muted-foreground">
                        Dùng mô hình ngôn ngữ siêu tốc chuẩn hóa theo
                        instruction
                      </span>
                    </div>
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateConfigField("use_llm", checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfigField("module_code", e.target.value)
                      }
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateConfigField("profile", e.target.value)
                        }
                        className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                      />
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateConfigField("require_citations", checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      value={String(
                        configState.tool_id || configState.tool_name || "",
                      )}
                      onChange={(e) =>
                        updateConfigField("tool_id", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateConfigField("http_method", e.target.value)
                        }
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfigField("default_node", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                    />
                  </div>
                  <span className="text-[10px] text-muted-foreground">
                    ...
                    {Array.isArray(configState.rules)
                      ? configState.rules.length
                      : 0}{" "}
                    quy tắc
                  </span>
                </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateConfigField("format", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground text-[11px]"
                    >
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateConfigField("include_citations", checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfigField("document_type", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                    />
                  </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      value={String(
                        configState.required_permission || "run.resume",
                      )}
                      onChange={(e) =>
                        updateConfigField("required_permission", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                    />
                  </div>
                ...
                <div className="space-y-2 p-2.5 rounded-control bg-muted/40 border border-border/80 text-[11px]">
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <Switch
                      ...
                      checked={
                        configState.require_citation_for_answer !== false
                      }
                      onCheckedChange={(checked) =>
                        updateConfigField(
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfigField("invalid_route", e.target.value)
                      }
                      className="w-full h-7 px-2 rounded-control border border-border bg-background text-foreground font-mono text-[11px]"
                    />
                  </div>
