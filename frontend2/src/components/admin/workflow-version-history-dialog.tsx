...
export const WorkflowVersionHistoryDialog: React.FC<
  WorkflowVersionHistoryDialogProps
> = ({ workflowId, workflowName, isOpen, onClose, onRollbackSuccess }) => {
  ...
  const latestVersionNumber =
    versions.length > 0
      ? Math.max(...versions.map((v: WorkflowVersion) => v.version_number))
      : 0;
            ...
            {versionsQuery.isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
                ...
                <p className="text-xs font-medium">
                  Chưa có phiên bản xuất bản nào
                </p>
                <p className="text-[11px] opacity-75">
                  Hãy nhấn nút "Xuất bản" trên thanh công cụ Canvas để lưu phiên
                  bản bất biến đầu tiên.
                </p>
              </div>
            ) : (
                      ...
                      >
                        <div className="min-w-0 space-y-1">
                          ...
                          <div className="flex items-center gap-3 text-[11px] text-muted-foreground">
                            ...
                            <span>•</span>
                            <span>
                              Bởi: {ver.published_by || "Quản trị viên"}
                            </span>
                            <span>•</span>
