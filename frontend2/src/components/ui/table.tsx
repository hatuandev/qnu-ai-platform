  ...
  return (
    ...
    >
      <table
        data-slot="table"
        className={cn(
          "type-table w-full min-w-[640px] caption-bottom sm:min-w-0",
          className,
        )}
        {...props}
      />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "type-table-header h-10 px-3 text-left align-middle font-semibold text-muted-foreground [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
