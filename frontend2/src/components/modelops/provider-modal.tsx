...
export const ProviderModal: React.FC<ProviderModalProps> = ({
  ...
  const [providerType, setProviderType] =
    useState<ModelProvider["type"]>(initialType);
      ...
      <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Chọn mẫu cấu hình sẵn từ các nhà cung cấp phổ biến hoặc tự do tùy
            chỉnh thông số kết nối.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={providerType}
                onValueChange={(val) =>
                  setProviderType(val as ModelProvider["type"])
                }
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="mistral">
                    Mistral AI (OCR & Mistral Large)
                  </SelectItem>
                  <SelectItem value="cloudflare">
                    Cloudflare Workers AI (Edge GPU)
                  </SelectItem>
          ...
          <div className="flex items-center justify-between pt-1">
            <div className="flex items-center gap-2">
              ...
              <label
                ...
                className="font-semibold text-foreground text-xs cursor-pointer select-none"
              >
