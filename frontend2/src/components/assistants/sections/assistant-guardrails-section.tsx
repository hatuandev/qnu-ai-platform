    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-xs">
          Chính sách bảo vệ an ninh và chuẩn mực chống bịa đặt
          (Anti-Hallucination).
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2.5">
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Khử lệnh can thiệp độc hại
              </p>
            </div>
            <Switch
              checked={form.block_prompt_injection}
              onCheckedChange={(val) =>
                onChange({ ...form, block_prompt_injection: val })
              }
          ...
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            <div>
              <p className="font-semibold text-foreground">
                Che Dữ Liệu Cá Nhân (PII)
              </p>
              <p className="text-xs text-muted-foreground">
                Tự động ẩn CCCD, SĐT, Email
              </p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            ...
            <Switch
              ...
              onCheckedChange={(val) =>
                onChange({ ...form, require_grounded_answer: val })
              }
          ...
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            <div>
              <p className="font-semibold text-foreground">
                Bảo Vệ System Prompt
              </p>
              <p className="text-xs text-muted-foreground">
                Chống rò rỉ chỉ thị nội bộ
              </p>
            </div>
            <Switch
              checked={form.protect_system_prompt}
              onCheckedChange={(val) =>
                onChange({ ...form, protect_system_prompt: val })
              }
          ...
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            ...
            <Switch
              ...
              onCheckedChange={(val) =>
                onChange({ ...form, human_approval_required: val })
              }
          ...
          <div className="flex items-center justify-between rounded-md border p-2.5 text-xs">
            ...
            <Switch
              ...
              onCheckedChange={(val) =>
                onChange({ ...form, require_citations: val })
              }
        ...
        <Field
          htmlFor="detail-no-answer"
          label="Thông Điệp Từ Chối (No-Answer Policy)"
        >
          <Textarea
            id="detail-no-answer"
            rows={3}
            ...
            onChange={(e) =>
              onChange({ ...form, no_answer_message: e.target.value })
            }
          />
        </Field>
        ...
        <div className="rounded-md border border-primary/20 bg-primary/5 p-3.5 space-y-2.5">
          ...
          <Button
            ...
            onClick={() =>
              onNavigate(
                `/evaluation?assistant=${encodeURIComponent(assistantCode)}`,
              )
            }
          >
