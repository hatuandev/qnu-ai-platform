      ...
      <DialogContent className="max-w-xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                ...
                Trường ĐH Quy Nhơn để tích hợp trợ lý.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="mt-3 space-y-3">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Widget hỗ trợ phản hồi Streaming thời gian thực (SSE), hiển thị
            trích dẫn tài liệu chính thức và tự động nhận diện thương hiệu QNU
            Academic Teal.
          </p>
        </div>
