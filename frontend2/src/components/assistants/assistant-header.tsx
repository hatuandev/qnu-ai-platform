...
export function AssistantHeader({
  ...
  const passedChecksCount =
    readiness?.checks?.filter((c) => c.status === "passed").length ?? 0;
      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button
            ...
            onClick={() =>
              onNavigate(
                `/assistants/${encodeURIComponent(assistantCode)}/playground`,
              )
            }
          >
            ...
            <div className="flex items-center gap-1.5 shrink-0 self-end sm:self-center">
              ...
              {onRefetchReadiness && (
                ...
                >
                  <RefreshCw
                    className={cn(
                      "size-3.5",
                      isReadinessFetching && "animate-spin",
                    )}
                  />
                  Kiểm tra
                </Button>
              ...
              {onPublish && (
                <Button
                  ...
                  disabled={
                    isPublishing ||
                    (!assistant.is_active && !readiness.is_ready_for_publish)
                  }
                  onClick={onPublish}
