...
const INITIAL_WORKFLOWS: Record<string, WorkflowConfig> = {
  admissions: {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          category: "output",
          description: "Định dạng câu trả lời kèm bảng điểm chuẩn và hotline tư vấn.",
    ...
    edges: [
      ...
      { id: "e5", source: "citation_guard", target: "final_output", animated: true },
    ],
  },
  regulations: {
    code: "regulations",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          id: "condition_route",
          label: "Phân loại đối tượng SV",
          category: "route",
          configSummary: "SV chính quy | SV liên thông | Vừa làm vừa học",
          timeoutSeconds: 2,
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          category: "output",
          description: "Xuất phản hồi chi tiết và biểu mẫu đơn phúc khảo (nếu cần).",
          timeoutSeconds: 2,
        },
      },
    ],
    edges: [
      { id: "e1", source: "chat_input", target: "condition_route", animated: true },
      { id: "e2", source: "condition_route", target: "regulations_rag", label: "Tra cứu quy chế" },
      { id: "e3", source: "regulations_rag", target: "citation_check", animated: true },
      { id: "e4", source: "citation_check", target: "final_output", animated: true },
    ],
  },
  drafting: {
    code: "drafting",
