    ...
    >
      <div className="flex items-center gap-2 mb-1.5">
        ...
        <div className="ml-auto flex items-center gap-1">
          <NodeStatusIndicator status={data.status} durationMs={data.durationMs} />
...
const LLMGenerateNode = ({ data, selected }: NodeProps<Node<WorkflowNodeData>>) => {
  const isRunning = data.status === "running";
  return (
    <div
      className={`min-w-[220px] rounded-surface bg-card border-2 p-3 shadow-xs transition-all ${
...
const HumanApprovalNode = ({ data, selected }: NodeProps<Node<WorkflowNodeData>>) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1.5">
        ...
        <div className="ml-auto flex items-center gap-1">
          <NodeStatusIndicator status={data.status} durationMs={data.durationMs} />
          <Badge variant="outline" className="text-[10px] font-mono text-orange-600">
            checkpoint
          </Badge>
        </div>
      </div>
