...
export function AssistantVersionHistoryDialog({
  ...
  const [rollbackTarget, setRollbackTarget] = React.useState<AssistantVersionItem | null>(null);
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              ...
              <strong className="text-foreground">{assistantName}</strong>. Mỗi lần lưu hoặc xuất
              bản đều tự động tạo một snapshot bất biến.
            </DialogDescription>
          </DialogHeader>
                ...
                {versions.map((ver, idx) => (
                  ...
                  >
                    <div className="space-y-1.5 flex-1 min-w-0">
                      ...
                      <p className="text-foreground font-medium text-xs">{ver.change_summary}</p>
                      {ver.snapshot_data && (
