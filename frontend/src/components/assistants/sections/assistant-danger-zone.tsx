...
export function AssistantDangerZone({
  ...
  return (
    <Card className={assistant.is_active ? "border-destructive/30" : "border-success/30"}>
      <CardHeader className="pb-3">
        <CardTitle className="text-sm font-bold">
          {assistant.is_active ? "Vùng Nguy Hiểm" : "Khôi Phục Trạng Thái Hoạt Động"}
        </CardTitle>
      ...
      <CardContent>
        {assistant.is_active ? (
          <ConfirmDialog
            ...
            trigger={
              <Button type="button" variant="destructive" size="sm" className="text-xs gap-1.5">
