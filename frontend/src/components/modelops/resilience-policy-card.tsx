      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="p-4 space-y-2">
          ...
          <p className="text-[11px] text-muted-foreground">
            Khi một khóa chạm Rate Limit HTTP 429 hoặc cạn Token Quota, hệ thống lập tức chuyển sang
            khóa dự phòng kế tiếp và đưa khóa cũ vào thời gian nghỉ (Cooldown 60s).
          </p>
        </Card>
          ...
          <div className="p-3 rounded-md bg-muted/40 border border-border/80 text-xs space-y-1 font-mono">
            <p className="text-foreground">
              ...
              <span className="text-primary font-bold">
                {activeProviderNames.join(" → ") || "Chưa có provider kích hoạt"}
              </span>
            </p>
          </div>
          <p className="text-[11px] text-muted-foreground">
