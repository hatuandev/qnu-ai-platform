    ...
    <div className="space-y-4">
      <Card className="p-5 border-border">
        <form onSubmit={onSandboxSearch} className="space-y-3">
          <label htmlFor="sandbox-query" className="text-xs font-semibold text-foreground block">
          ...
          <div className="mt-5 space-y-3 pt-4 border-t border-border">
            ...
            {sandboxResults.map((res) => (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground font-mono">Phương pháp: {res.method}</p>
              </div>
            ))}
          </div>
        )}
