    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-1.5 px-1 font-medium text-foreground text-xs">
          ...
          />
          <span className="text-muted-foreground text-xs font-mono">/ {totalPages}</span>
        </div>
      ...
      <button
        ...
        title={showBoxes ? "Ẩn khung nhận diện scan" : "Hiện khung nhận diện scan"}
      >
        {showBoxes ? <Eye className="size-3.5 text-primary" /> : <EyeOff className="size-3.5" />}
