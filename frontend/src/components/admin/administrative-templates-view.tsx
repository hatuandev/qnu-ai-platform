...
import { ADMINISTRATIVE_TEMPLATES, type AdministrativeTemplate } from "../../services/api-client";
...
export const AdministrativeTemplatesView: React.FC<AdministrativeTemplatesViewProps> = ({
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">
              Các phôi mẫu đã được thẩm định thể thức theo Nghị định 30/2020/NĐ-CP và thang Bloom
            </p>
          </div>
        </div>
          ...
          >
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-medium text-primary">{tpl.standard}</span>
              </div>

              <div>
                <h4 className="font-semibold text-xs text-foreground leading-snug">{tpl.title}</h4>
              ...
              <div className="text-[10px] font-mono text-muted-foreground flex items-center gap-1">
                <span>Đơn vị:</span>
                <span className="text-foreground font-semibold">{tpl.department}</span>
              </div>
