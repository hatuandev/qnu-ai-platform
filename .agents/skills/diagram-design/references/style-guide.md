...
name: QNU AI Platform (Academic Teal)
slug: qnu-teal
source-url: https://qnu.edu.vn
created: 2026-09-20
updated: 2026-09-20
notes: Quy Nhon University official academic teal brand palette
-->
# Style Guide
...
Customized for **QNU AI Platform (Trường Đại học Quy Nhơn)** with Academic Teal (`#0f766e` / `oklch(0.46 0.13 160)`), crisp modern backgrounds, and refined editorial typography.
...
|---|---|---|---|
| `paper` | Page background, default node fill | `#ffffff` | `#0f172a` (slate-900) |
| `paper-2` | Diagram container bg, secondary fill | `#f8fafc` (slate-50) | `#1e293b` (slate-800) |
| `ink` | Primary text, primary stroke | `#0f172a` (slate-900) | `#f8fafc` (slate-50) |
| `ink-strong` | High-contrast text on warm accent fills | `#ffffff` | `#ffffff` |
| `muted` | Secondary text, default arrow stroke | `#475569` (slate-600) | `#94a3b8` (slate-400) |
| `soft` | Sublabels, boundary labels | `#64748b` (slate-500) | `#64748b` (slate-500) |
| `rule` | Hairline borders | `rgba(15,23,42,0.10)` | `rgba(248,250,252,0.12)` |
| `rule-solid` | Stronger borders, baselines | `#cbd5e1` (slate-300) | `rgba(148,163,184,0.25)` |
| `accent` | Focal / 1–2 max per diagram | `#0f766e` (Academic Teal) | `#14b8a6` (Teal-400) |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(15,118,110,0.08)` | `rgba(20,184,166,0.12)` |
| `link` | HTTP/API calls, external arrows | `#0284c7` (sky-600) | `#38bdf8` (sky-400) |

> **Brand palette source:** QNU AI Platform Academic Teal brand identity — `oklch(0.46 0.13 160)` / `#0f766e`, `slate-900 #0f172a`, `slate-50 #f8fafc`. Matches the UI Design System of QNU AI Platform.
