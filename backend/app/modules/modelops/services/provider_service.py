        ...
        "extra_config": {
            ...
            "model_specs": {
                "gemini-2.5-flash": {
                    ...
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "Bóc tách văn bản, bảng biểu PDF scan & hình ảnh siêu tốc (Khuyên dùng OCR)",
                },
                "gemini-2.5-flash-lite": {
                    "can_ocr": True,
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "Vision OCR siêu nhẹ, phản hồi nhanh, tối ưu chi phí",
                },
                "gemini-2.5-pro": {
                    "can_ocr": True,
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "OCR tài liệu phức tạp, phân tích cấu trúc bảng biểu nhiều tầng",
                },
                "gemini-3.1-flash-lite": {
                    "can_ocr": True,
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "Google 3.1 Flash Vision OCR thế hệ mới siêu tốc",
                },
                "gemini-3.1-flash-image": {
                    "can_ocr": True,
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "Mô hình chuyên biệt xử lý hình ảnh và tài liệu scan",
                },
                "gemini-3.1-pro-preview": {
                    "can_ocr": True,
                    "can_vision": True,
                    "type": "vision_ocr",
                    "description": "Google 3.1 Pro Đa phương thức cao cấp preview",
                },
                "gemma-4-26b-a4b-it": {
                    "can_ocr": False,
                    "can_vision": False,
                    "type": "text",
                    "description": "Mô hình ngôn ngữ thuần text open-weights (Không hỗ trợ OCR/Vision)",
                },
                "gemma-4-31b-it": {
                    "can_ocr": False,
                    "can_vision": False,
